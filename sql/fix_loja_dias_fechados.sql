create table if not exists public.loja_dias_fechados (
...
drop policy if exists loja_dias_fechados_select_auth on public.loja_dias_fechados;
create policy loja_dias_fechados_select_auth on public.loja_dias_fechados
for select using (auth.role() = 'authenticated');

drop policy if exists loja_dias_fechados_write_admin on public.loja_dias_fechados;
